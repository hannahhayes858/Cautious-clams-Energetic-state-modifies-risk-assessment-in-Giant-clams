...
#View a boxplot of the log10 of hiding time as a function of treatment
boxplot(exp1$log10_after~exp1$Treatment, xlab = "Treatment", ylab = "log10(hiding time after treatment)", main = "Figure 1")
...
#Boxplot of log10 hiding time after as the response variable to treatment
boxplot(exp2$log10_after~exp2$Treatment, xlab="Treatment", ylab = "log10(hiding time after treatment)", main= "Figure 1")
...
#Boxplot of log10 hiding time after as the response variable to treatment
boxplot(exp2_3day$log10_after~exp2_3day$Treatment, xlab="Treatment", ylab = "log10(hiding time after treatment)", main= "Figure 2")
...
#Run without the random effect to see how much the random effect coontributes to the results
lm1 <- lm(log10_after~ Size_cm + Treatment_Number + Treatment, data=exp2_3day)
summary(lm1)

#Calculate the r^2 of linear mixed model to determine the contribution of random effect to explanation of variance
r.squaredGLMM(m3)

#Run an anova comparing the linear mixed model to the linear model to test the random effect
anova(m3,lm1)

emmeans(m3, "Treatment")
...
#Visualize boxplot
boxplot(exp3$log10_after~exp3$Treatment, xlab="Treatment", ylab = "log10(hiding time after treatment)", main= "Final cams")
